...
draft = false
image = "/images/posts/2017-02-19-tdf2017/ufo.png"
math = false
slug = "tdf2017"
...
セミナーでは、尊敬している東京大学の蜂須賀先生のお話を聞くことができました。
さらに他の参加者とレイマーチングなどのCG技術について深い議論ができました。

TDFについて書きたいことはたくさんあるのですが、この記事では自分の作品の解説を中心に紹介していきます。
...
![ノーマルマップを使ったマテリアル](/images/posts/2017-02-19-tdf2017/normal.png)
...
![どんなフレンズの作品に会えるかな？](/images/posts/2017-02-19-tdf2017/friends.png)
TDFのオープニングセレモニーの様子
