...
制限時間や出力解像度をコマンドラインで引数で指定する機能を提出日前日くらいに実装しました。
...
詳細は後編の記事に書く予定ですが、今年は特に面白いイベントが盛りだくさんでした。
運営・企画してくださったqさんやholeさんに感謝を申し上げます。
