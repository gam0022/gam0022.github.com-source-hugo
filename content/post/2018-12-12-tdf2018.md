...
レイマーチング（別名 Sphere Tracing）とは、距離関数と呼ばれる数式で定義したシーンに対して、レイの衝突判定を行って絵を出すレイトレーシングに分類される手法です。レイマーチングの詳細は[このスライド](https://www.slideshare.net/shohosoda9/threejs-58238484)をご参照ください。
...
TODO: 演出の詳細はUnityアドベントカレンダーで書きます。
