...
この手法はあまり推奨しないほうが良いと思いますが…

ほとんどの[ドメインの取得から60日経過すれば移管できる](https://help.onamae.com/answer/8577)ようになります。

お名前.comは初年度がありえないほど安いので、ドメインの取得だけお名前.comで行なって、60日経過後に他社に移管することでコストを最小化できそうな気がしています。
