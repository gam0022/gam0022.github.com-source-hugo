...
コロナウイルスの影響で私も先月からリモートワークになりました。
...
グラフィックエンジニアなら人権ラインのスペックだと思われます。
...
レビューはかなり高評価でしたが、メンブレン式ですので、打鍵感が気になる人はHHKBやREALFORCEを買ったほうが幸せになれるような気がしました。
...
また、ワイヤレスの魅力に取り憑かれると、すべてをワイヤレスに統一したい欲求が出てくるので、危険かもしれません。