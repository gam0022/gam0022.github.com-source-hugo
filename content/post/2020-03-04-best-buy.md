...
slug = "best-buy"
date = "2020-03-05T21:20:06+09:00"
image = ""
toc = true
...
コロナウイルスの影響で急速にリモートワークが広まっているようですね。

私の会社でもリモートワークが推奨されました。

普段あまり自宅で作業をしないという方にとっては、自宅の作業環境を見直すきっかけになったのではないでしょうか？

せっかくなので、この機会に私の作業環境を紹介しようと思います。
...
キーボードはレビューがかなり高評価でしたが、メンブレン式ですので、打鍵感が気になる人はHHKBやREALFORCEを買ったほうが幸せになれるような気がしました。
