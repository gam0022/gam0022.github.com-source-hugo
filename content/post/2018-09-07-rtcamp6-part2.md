...
圧倒的なポリゴンの物量ですがどうやってこの速度を実現できているのか不思議でした。
...
- Houdini は Ushio さん
- Maya は yopio さん
  - Mayaのプラグインを開発して、Mayaからの直接レンダリングを実現！
...
もちろんshinjiさんやholeさんのようにプロシージャルにシーン生成するアプローチで割り切る手もあると思いますが、
意図的にシーンをレイアウトしたいのであれば、DCCツール連携が賢い解決策だと思いました。

#### 初回参加者の方々が強い

また、初回参加者の方々が強いのも印象的でした。

mizutoriさんはCG分野を研究されている学生で、BSSRDF（表面下化散乱）やNEEやMISなど、比較的難しいことに挑戦されていました。
...
個人的に実装したいテーマなので、[参考資料](Monte Carlo Rendering with Natural Illumination)の紹介が助かりました。

tabochanさんは磨りガラスの中に光源があるというレンダラーへの嫌がらせのような難しそうなシーンに挑戦されていました。
...
レーシングゲームかと思いきや、まさかの敵の車に体当たりして破壊するゲームでしたｗ
