...
今回のためだけにプログラミングとGLSLを習得していただき、コーディングのみで作曲していただいたさだきちさんには感謝しかありません。

かなり無茶なお願いだったにも関わらず、かっこいいトランスミュージックを作っていただきました！ありがとうございます！

私自身もWebフロントエンドは久しぶりだったので、今回の制作でかなり勉強になりました。
...
あとは、演算子オーバーロードさえあれば、3Dプログラミングでも十分に実用的な言語になるのではないかと個人的には思うので、早く対応してほしいです。
...
今回の結果の慢心せず、logicomaやLJやConspiracyやMonadやPolarityレベルのかっこいい64K Introを作れるように引き続き努力していきたいです。