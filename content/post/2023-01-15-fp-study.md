...
たとえば、近所で家を建て替えた時に道路の幅が広がっていたのを見て、これは[セットバック](https://suumo.jp/article/oyakudachi/oyaku/chumon/c_knowhow/set_back/)だったんだと気がつけたり
...
たくさんの参考書が出版されていますが、FP試験は出題範囲がとても広く、最初から最後まで全部理解して覚えようとすると時間がかかりすぎます。
FP試験で問題として出題される内容には傾向があるので、参考書を隅から隅まで網羅して覚えようとするのはタイムパフォーマンスが悪いです。
...
FP3級は問題数が少ないので普通に解いていたら時間が余ると思うのですが、FP2級は問題数が多いので時間配分にも注意する必要があります。

FP2級では時間配分まで意識しながら過去問を解いていきましょう。

基本的に過去問道場を利用して解くのが良いと思いますが、FP2級なら過去問を紙に印刷して本番と同じ制限時間で解く練習は1回しておくのがオススメです。
...
上で紹介したおーちゃんさんが企画協力している参考書を買いました。
YouTubeの語呂合わせなど共通している部分も多いので、この分野は理解を深めたいというところを読むのにオススメです。
